const  XBOT = 'Hiro.Bot'; // Nama Bot Whatsapp
const instagram = 'https://instagram.com/Regyna.ft'; // Nama Instagramlu cok
const nomer = 'https://Wa.me/+62881026065014'; // Nomor whatsapplu cok
const aktif = 'Tergantung kuota'; // Kapan bot lu aktif
const groupwa = 'comming soon'; // OFFICIAL GRUP LU 1
const youtube = 'https://Kyroad gaming'; 
